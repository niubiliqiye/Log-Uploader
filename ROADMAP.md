...
- 已完成：Core 基线、Core 测试闭环、HTTP 上传可用、Admin 查询可用、宿主联调通过、Alpha 收口
- 下一阶段：进入 `0.1.0-beta.1` 准备
...
**版本示例**：0.1.0-alpha.1（Core 基线）、0.1.0-alpha.2（Core 测试闭环）、0.1.0-alpha.3（Http 上传）、0.1.0-alpha.4（Admin 查询）
